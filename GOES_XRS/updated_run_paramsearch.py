...
params = {
    'xrsb': [[0, 1e-6, 2e-6, 3e-6, 4e-6, 4.5e-6, 5e-6, 6e-6, 7e-6], flare_data['xrsb'], 'W/m^2'],
    'xrsa': [[0, 1e-7, 2.5e-7, 3e-7, 3.5e-7, 4e-7, 4.5e-7, 5e-7, 5.5e-7], flare_data['xrsa'], 'W/m^2'],
    ...
    '3minxrsa': [[0, 1e-7, 2e-7, 3e-7, 4e-7, 5e-7], cparam['XRSA 3-min Differences'], 'W/m^2'],
    '5minxrsa': [[0, 1e-7, 2e-7, 3e-7, 4e-7, 5e-7], cparam['XRSA 5-min Differences'], 'W/m^2'],
